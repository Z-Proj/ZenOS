...
#define SYSCALL_UNIX_SOCKET      76
#define SYSCALL_UNIX_BIND        77
#define SYSCALL_UNIX_LISTEN      78
#define SYSCALL_UNIX_ACCEPT      79
#define SYSCALL_UNIX_CONNECT     80
#define SYSCALL_UNIX_SEND        81
