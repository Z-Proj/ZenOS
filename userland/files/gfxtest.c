// gfxdemo.c — sends shapes + text to gfxserver over socket
...
int main() {
    ...
    gfx_text(gfx, 8, 32, 0xFF555577, 10, "via gfxserver socket");
    ...
    gfx_rect(gfx,     117, 325, 26, 23, 0xFF4466AA); // door
    gfx_triangle(gfx, 130, 285, 97, 313, 163, 313, 0xFFAA4433); // roof
    // windows
    gfx_rect_outline(gfx, 104, 315, 10, 10, 0xFFFFFFAA);
    gfx_rect_outline(gfx, 147, 315, 10, 10, 0xFFFFFFAA);

    // ── unicode text showcase ──
