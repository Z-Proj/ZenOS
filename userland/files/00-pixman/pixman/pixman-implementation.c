...
_pixman_arm_get_implementations (pixman_implementation_t *imp) { return imp; }

pixman_implementation_t *
_pixman_ppc_get_implementations (pixman_implementation_t *imp) { return imp; }

pixman_implementation_t *
_pixman_mips_get_implementations (pixman_implementation_t *imp) { return imp; }

pixman_implementation_t *
_pixman_riscv_get_implementations (pixman_implementation_t *imp) { return imp; }
