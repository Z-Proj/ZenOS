...
# include "libtcc.c"
#endif
#ifndef TCC_TARGET_ZENOS
# include "tcctools.c"
#else
static int tcc_tool_cross(char **argv, int opt) { return 1; }
static int tcc_tool_ar(int argc, char **argv) { return 1; }
#endif
